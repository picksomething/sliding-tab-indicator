...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i == mViewPager.getCurrentItem()) {
                ...
                tabTitleView.setTextColor(mTextFocusColor);
            } else {
                tabTitleView.setTextColor(mTextDefaultColor);
            }
        }
    }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                if (i == position) {
                    ((TextView) mTabStrip.getChildAt(i)).setTextColor(mTextFocusColor);
                } else {
                    ((TextView) mTabStrip.getChildAt(i)).setTextColor(mTextDefaultColor);
                }
            }
